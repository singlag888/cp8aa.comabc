...
$(function() {
    BJUI.init({
        ...
        loginInfo    : {url:"<?php echo U('Publics/timeout');?>", title:'登录', width:500, height:200}, // 会话超时后弹出登录对话框
        ...
        ui           : {
                         windowWidth      : 0, //框架显示宽度，0=100%宽，> 600为则居中显示 1200
...
function createLink(){      //临时图片上传路径
	return "<?php echo U('Attachment/ajax_pasteImage');?>";
}
</script>
<!-- for doc begin -->
...
<link href="/Public/Admin/css/doc.css" rel="stylesheet">
<script type="text/javascript">
$(function(){
    SyntaxHighlighter.config.clipboardSwf = '/Public/Admin/js/syntaxhighlighter-2.1.382/scripts/clipboard.swf'
...
<body>
    ...
    <header id="bjui-header">
        ...
        <nav id="bjui-navbar-collapse">
            <ul class="bjui-navbar-right">
                ...
                <li><a href="<?php echo U('System/profile');?>" data-toggle="dialog" data-id="System_profile" data-mask="true" data-width="600" data-height="260">&nbsp;<span class="glyphicon glyphicon-user"></span> 我的资料</a></li>
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><?php echo (cookie('username')); ?> <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="<?php echo U('System/changePassword');?>" data-toggle="dialog" data-id="System_changePassword" data-mask="true" data-width="600" data-height="260">&nbsp;<span class="glyphicon glyphicon-lock"></span> 修改密码&nbsp;</a></li>
                        <li><a href="<?php echo U('System/profile');?>" data-toggle="dialog" data-id="System_profile" data-mask="true" data-width="600" data-height="260">&nbsp;<span class="glyphicon glyphicon-user"></span> 我的资料</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo U('Publics/logout');?>" class="red">&nbsp;<span class="glyphicon glyphicon-off"></span> 注销登陆</a></li>
                    </ul>
                </li>
                <!--<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">语言 <span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="/index.php?l=zh-cn">&nbsp; 简体&nbsp;</a></li>
                        <li><a href="/index.php?l=en-us">&nbsp; English</a></li>
                    </ul>
                </li>
    ...
    <footer id="bjui-footer">Copyright &copy; 2015　<a href="#" target="_blank">一起PHP</a>　
    </footer>
    </div>
</body>
</html>