...
-->
    ...
    <section class="article_box clearfix">
        <aside class="article_left">
            <div class="article_cent">
                <h1><?php echo ($Detail["title"]); ?></h1>
                <span class="article_time"><?php echo (date("Y-m-d H:i:s",$Detail["inputtime"])); ?> 来源：网络</span>
                <article>
                    <?php echo ($Detail["content"]); ?>
                </article>
            </div>
            <div class="xianguan_text">
                <h6>相关文章阅读</h6>
                <ul>
                    <?php if(is_array($dataInfo)): foreach($dataInfo as $key=>$item): ?><li>
                            <i></i>
