...
class Oauth{
    ...
    const VERSION = "2.0";
    const GET_AUTH_CODE_URL = "https://graph.qq.com/oauth.0/authorize";
    const GET_ACCESS_TOKEN_URL = "https://graph.qq.com/oauth.0/token";
    const GET_OPENID_URL = "https://graph.qq.com/oauth.0/me";
